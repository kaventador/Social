...
class UserRegistrationForm(forms.Form):
    ...
    password2 = forms.CharField(label='confirm password',widget=forms.PasswordInput(attrs={'class':'form-control','placeholder':'your confirm password'}))
    ...
    def clean_username(self):
        ...
        if user:
            raise ValidationError('this username is already')
        return username
